...
lbl = Label(window, text="STUDENT PERSONAL INFORMATION", fg="Black", bg="Cyan")
lbl.place(x=175, y=60, anchor="center")
...
txtfld = Entry(window, bd=3, font=("verdana", 13))
